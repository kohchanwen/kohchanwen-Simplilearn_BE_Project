...
<c:set var="fullName" scope="session" value="${param.fullName}"/>
<c:set var="email" scope="session" value="${param.email}"/>
<c:set var="address" scope="session" value="${param.address}"/>
<c:set var="passportNo" scope="session" value="${param.passportNo}"/>
<c:set var="country" scope="session" value="${param.country}"/>
<c:set var="mobile" scope="session" value="${param.mobile}"/>
<c:set var="age" scope="session" value="${param.age}"/>
